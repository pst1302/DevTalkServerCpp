========================================================================
    응용 프로그램: DevTalkServerInCpp 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 DevTalkServerInCpp 응용 프로그램을 만들었습니다.  

DevTalkServerInCpp 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

DevTalkServerInCpp.vcxproj
...
DevTalkServerInCpp.vcxproj.filters
